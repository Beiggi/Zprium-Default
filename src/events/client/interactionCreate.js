...
module.exports = async (client, interaction) => {
    ...
    banSchema.findOne({ User: interaction.user.id }, async (err, data) => {
      if (data) {
        return client.errNormal(
          {
            error: "You have been banned by the developers of Zprium",
            type: "ephemeral",
          },
          interaction
        );
  ...
  // Verify system
  if (interaction.isButton() && interaction.customId == "Zprium_verify") {
    ...
    if (data) {
      ...
      client.errNormal(
        {
          error:
            "Verify is disabled in the Club! Or you are using the wrong channel!",
          type: "ephemeral",
        },
        interaction
      );
  ...
  // Tickets
  if (interaction.customId == "Zprium_openticket") {
  ...
  if (interaction.customId == "Zprium_closeticket") {
  ...
  if (interaction.customId == "Zprium_claimTicket") {
  ...
  if (interaction.customId == "Zprium_transcriptTicket") {
  ...
  if (interaction.customId == "Zprium_deleteTicket") {
  ...
  if (interaction.customId == "Zprium_noticeTicket") {
