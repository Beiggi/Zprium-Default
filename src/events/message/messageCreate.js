...
module.exports = async (client, message) => {
  ...
  if (message.channel.type === Discord.ChannelType.DM) {
    let embedLogs = new Discord.EmbedBuilder()
      .setTitle(`<:_:1171916318610563102>・New DM message!`)
      .setDescription(`Zprium has received a new DM message!`)
      .addFields(
        {
          name: "<:_:1170778648870125721>┆Send By",
          value: `${message.author} (${message.author.tag})`,
          inline: true,
        },
        {
          name: `<:_:1171916318610563102>┆Message`,
    ...
    if (message.attachments.size > 0)
      embedLogs.addFields({
        name: `<a:_:1172581280802676837>┆Attachments`,
  ...
  if (
    ...
    client
      .embed(
        {
          title: "Hi, i'm Zprium",
          desc: `Use with commands via Discord <:_:1172827488179716147> commands`,
          fields: [
            {
              name: "<a:_:1170106925044740287>┆Invite your friends",
              value: `Invite your friends to the Club! [Click here](${client.config.discord.botInvite})`,
            },
            {
              name: "<a:_:1170105530728075314>┆Need support?",
