...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName("images")
    .setDescription("See all the images in Zprium")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("memes")
        .setDescription("See all the memes in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("clyde")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("animals")
        .setDescription("See all the animal images in Zprium")
        .addSubcommand((subcommand) =>
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("user")
        .setDescription("See all the user images in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("ad")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("extra")
        .setDescription("See all the extra images in Zprium")
        .addSubcommand((subcommand) =>
