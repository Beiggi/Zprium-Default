...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("fun")
    .setDescription("Run fun commands in Zprium")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("meme")
        .setDescription("See all the fun meme commands in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("confused")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("user")
        .setDescription("See all the fun user commands in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("hack")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("text")
        .setDescription("See all the fun text commands in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("ascii")
        ...
        .addSubcommand((subcommand) =>
          subcommand
            .setName("say")
            .setDescription("Have Zprium say something")
            .addStringOption((option) =>
              option
                .setName("text")
                .setDescription("Enter a text")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("extra")
        .setDescription("See all the fun extra commands in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("birdfact")
