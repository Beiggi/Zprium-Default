...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName("soundboard")
    .setDescription("Play all the sounds in Zprium")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("windows")
        .setDescription("Play the windows sounds in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("earrape")
        .setDescription("Play the earrape sounds in Zprium")
        .addSubcommand((subcommand) =>
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("songs")
        .setDescription("Play the song sounds in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("dancememe")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("discord")
        .setDescription("Play the discord sounds in Zprium")
        .addSubcommand((subcommand) =>
          subcommand
            .setName("discordcall")
    ...
    .addSubcommandGroup((group) =>
      group
        .setName("memes")
        .setDescription("Play the meme sounds in Zprium")
        .addSubcommand((subcommand) =>
