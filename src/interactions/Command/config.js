...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("config")
    .setDescription("Adjust Zprium to your taste")
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription("Set a custom channel name for the Club stats")
        .addStringOption((option) =>
          option
            .setName("name")
            .setDescription(
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription("Set Zprium level message")
        .addStringOption((option) =>
          option
            .setName("message")
            .setDescription(
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .setDescription("Set the ticket message of Zprium")
        .addStringOption((option) =>
          option
            .setName("type")
