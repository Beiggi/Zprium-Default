...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("economy")
    .setDescription("Play the economy game in the Club")
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("buy").setDescription("Buy items in the Zprium store")
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("store").setDescription("Show the store of this Club")
    )
    .addSubcommand((subcommand) =>
