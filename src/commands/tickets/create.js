              ...
              try {
                ...
                const row = new Discord.ActionRowBuilder().addComponents(
                  new Discord.ButtonBuilder()
                    .setCustomId("Zprium_closeticket")
                    .setEmoji("🔒")
                    .setStyle(Discord.ButtonStyle.Primary),

                  new Discord.ButtonBuilder()
                    .setCustomId("Zprium_claimTicket")
                    .setEmoji("✋")
                    .setStyle(Discord.ButtonStyle.Primary),

                  new Discord.ButtonBuilder()
                    .setCustomId("Zprium_transcriptTicket")
                    .setEmoji("📝")
                    .setStyle(Discord.ButtonStyle.Primary),

                  new Discord.ButtonBuilder()
                    .setCustomId("Zprium_noticeTicket")
                    .setEmoji("🔔")
                    .setStyle(Discord.ButtonStyle.Primary)
                );
                ...
                client
                  .embed(
                    {
                      title: `<a:_:1171248578891624459>・Progress`,
                    ...
                    if (ticketCategory == undefined) {
                      ...
                      interaction.guild.channels
                        ...
                        .then(async (channel) => {
                          client.embed(
                            {
                              title: `<a:_:1170117054586687488>・System`,
