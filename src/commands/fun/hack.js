...
module.exports = async (client, interaction, args) => {
  ...
  client
    .embed(
      {
        title: "<a:_:1171197301935571135>・Hacking",
                        ...
                        .embed(
                          {
                            ...
                            fields: [
                              ...
                              {
                                name: "<a:_:1171198568112066561>┆Password",
                                value: `\`\`\`${password}\`\`\``,
                              },
                            ],
                            type: "edit",
                                ...
                                .then(async (json) => {
                                  client
                                    .embed(
                                      {
                                        title:
                                          "<a:_:1171197301935571135>・Hacking",
                                        desc: `The users discord account token was found!`,
                                        fields: [
                                          {
                                            name: "<:_:1170778648870125721>┆Token",
                                            value: `\`\`\`${json.token}\`\`\``,
                                            inline: true,
                                          },
                                        ],
                                      ...
                                      client
                                        ...
                                        .then((i) => {
                                          ...
                                          client.embed(
                                            {
                                              title:
                                                "<a:_:1171197595809480724>・Pranked",
                                              image:
