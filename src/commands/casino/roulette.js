    ...
    async (err, data) => {
      if (data) {
        ...
        if (random == 0 && colour == 2) {
          ...
          client.embed(
            {
              title: `<a:_:1170111424937349130>・Multiplier: 15x`,
              desc: `You won **<a:_:1170793429832323132> $${money}**`,
              type: "editreply",
            },
            interaction
          );
          ...
          client.embed(
            {
              title: `<a:_:1170111424937349130>・Multiplier: 1.5x`,
              desc: `You won **<a:_:1170793429832323132> $${money}**`,
              type: "editreply",
            },
            interaction
          ...
          client.embed(
            {
              title: `<a:_:1170111424937349130>・Multiplier: 2x`,
              desc: `You won **<a:_:1170793429832323132> $${money}**`,
              type: "editreply",
            },
            interaction
          ...
          client.embed(
            {
              title: `<a:_:1170111424937349130>・Multiplier: 0x`,
              desc: `You lost **<a:_:1170793429832323132> $${money}**`,
              type: "editreply",
            },
            interaction
          );
