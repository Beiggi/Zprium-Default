...
module.exports = async (client, interaction, args) => {
  ...
  client.embed(
    {
      title: `<a:_:1169204360803266570>・${player.queue.current.title}`,
      ...
      fields: [
        ...
        {
          name: `<a:_:1170110120844341328>┆Duration`,
          value: `<t:${(
            Date.now() / 1000 +
        ...
        {
          name: `<a:_:1171929475588567132>┆Volume`,
          value: `${player.volume}%`,
          inline: true,
        },
        {
          name: `<a:_:1169204360803266570>┆Progress`,
          value:
