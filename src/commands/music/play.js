...
module.exports = async (client, interaction, args) => {
  ...
  client.simpleEmbed(
    {
      desc: `<:_:1172286293661720706>┆Searching...`,
      type: "editreply",
    },
    interaction
  );
  ...
  switch (res.loadType) {
    ...
    case "TRACK_LOADED": {
      ...
      if (!player.playing && !player.paused) {
        ...
        client.embed(
          {
            title: `<a:_:1169204360803266570>・${track.title}`,
            url: track.uri,
    ...
    case "SEARCH_RESULT": {
      ...
      client.embed(
        {
          title: `<:_:1172286293661720706>・Search Results`,
          desc: results,
          fields: [
            {
              name: `<a:_:1170105530728075314>┆Cancel search?`,
