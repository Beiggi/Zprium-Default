...
module.exports = (client) => {
  ...
  client.errNormal = async function (
    ...
    embed.setTitle(`<a:_:1171979021668581468>・Error!`);
    embed.setDescription(`Something went wrong!`);
    embed.addFields({
      name: "<a:_:1171979021668581468>┆Error comment",
      value: `\`\`\`${error}\`\`\``,
    });
  ...
  client.errUsage = async function (
    ...
    embed.addFields({
      name: "<a:_:1171979021668581468>┆Required arguments",
      value: `\`\`\`${usage}\`\`\``,
    });
    embed.setColor(client.config.colors.error);
  ...
  client.errMissingPerms = async function (
    ...
    embed.addFields({
      name: "<a:_:1171198568112066561>┆Required Permission",
      value: `\`\`\`${perms}\`\`\``,
    });
    embed.setColor(client.config.colors.error);
  ...
  client.errWait = async function (
    ...
    embed.addFields({
      name: "<a:_:1170110120844341328>┆Try again on",
      value: `<t:${time}:f>`,
    });
    embed.setColor(client.config.colors.error);
  ...
  client.succNormal = async function (
    ...
    embed.setTitle(`<a:_:1171840666062557225>・Success!`);
