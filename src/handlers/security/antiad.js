              ...
              Schema2.findOne(
                ...
                async (err, data2) => {
                  if (data2) {
                    ...
                    client.embed(
                      {
                        title: `<a:_:1171979021668581468>・Moderator`,
                        desc: `Discord links are not allowed in the Club!`,
                ...
                async (err, data2) => {
                  if (data2) {
                    ...
                    client.embed(
                      {
                        title: `<a:_:1171979021668581468>・Moderator`,
                        desc: `Links are not allowed in the Club!`,
                        color: client.config.colors.error,
                        content: `${message.author}`,
                      },
                      message.channel
                ...
                async (err, data2) => {
                  if (data2) {
                    ...
                    let error = new Discord.EmbedBuilder()
                      .setTitle(`<a:_:1171979021668581468>・Moderator`)
                      .setAuthor(client.user.username, client.user.avatarURL())
                      .setDescription(
                        `Discord links are not allowed in the Club!`
                      )
                ...
                async (err, data2) => {
                  if (data2) {
                    ...
                    var error = new Discord.EmbedBuilder()
                      .setTitle(`<a:_:1171979021668581468>・Moderator`)
                      .setAuthor(client.user.username, client.user.avatarURL())
                      .setDescription(`Links are not allowed in the Club!`)
                      .setColor(client.config.colors.error)
                      .setFooter({ text: client.config.discord.footer })
                      .setTimestamp();
                    var msg = newMessage.channel.send({
